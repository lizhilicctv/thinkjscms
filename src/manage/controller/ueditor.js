...
module.exports = class extends think.Controller {
  ...
  async islogin() {
    // 判断是否登录
    const user = await this.session('admin_id');
...
if(this.file('upfile')){
  var file = think.extend({}, this.file('upfile'));
  var filepath = file.path;
  //文件上传后，需要将文件移动到项目其他地方，否则会在请求结束时删除掉该文件
  //console.log(think.ROOT_PATH)
  
  var uploadPath = think.ROOT_PATH + '/www/static/ueditor';
  ...
  //fs.renameSync(filepath, uploadPath + '/' + "123.jpg");
  //console.log(uploadPath + '/' + name+".jpg")

  this.body= {
    "state":"SUCCESS",
    "url":'/static/ueditor/' + name+".jpg",
    "title":name+".jpg",
    "original":"",
    "type":".jpg"
  };
